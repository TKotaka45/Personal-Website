            ...
            <div className={home.information}>
                ...
                <div id={home.work} className={home.aboutMe}>
                    <p>
                        ...
                        <br /><br />
                        I am also a service technician at one of the top-performing retail stores of an international bicycle company. I diagnose and service customer bikes of all types, makes, and models. I am also responsible for the bike building team, I assist them in diagnosing and fixing issues with new bikes and train them on how to build bikes. The service team set global company records and was the highest-performing store in service in 2021.
                        <br /><br />
